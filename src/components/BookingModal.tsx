...
const BookingModal = ({ restaurant, open, onClose }: Props) => {
      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-lg rounded-2xl bg-card border border-border shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto"
          >
            ...
            {step === 'form' ? (
              <div className="p-6 space-y-5">
                {!isAuthenticated && (
                  <div className="rounded-xl bg-accent/10 border border-accent/30 p-3 text-sm text-accent-foreground">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="rounded-lg border border-border w-10 h-10 flex items-center justify-center text-foreground hover:bg-muted transition-colors"
                    >
                      -
                    </button>
                ...
                <button
                  ...
                  disabled={!isValid}
                  className={cn("btn-premium w-full text-center", !isValid && "opacity-50 cursor-not-allowed")}
                >
                  Confirm Reservation
                </button>
              </div>
